	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				default: 'business',
				required: true,
				description: 'Entity type for the client (or enter custom value)',
			},
			{
			...
			},
			{
				...
				type: 'string',
				displayOptions: { show: { resource: ['lead'], operation: ['bulkAction'], leadBulkAction: ['update_status'] } },
				default: '',
			...
			},
			{
				...
				type: 'string',
				displayOptions: { show: { resource: ['lead'], operation: ['bulkAction'], leadBulkAction: ['assign'] } },
				default: '',
					...
					if (operation === 'list') {
						...
						response = await this.helpers.httpRequestWithAuthentication.call(this, 'tukiGrowthApi', {
							...
							body: {
								...
								entityType: this.getNodeParameter('entityType', i) as string,
								...additionalFields,
							},
							json: true,
						});
